...
struct vec3
{
    ...
    {
        float xx, yy, zz, ww;
        xx = x * matrix.m[0 * 4 + 0] + y * matrix.m[0 * 4 + 1] + z
            * matrix.m[0 * 4 + 2] + matrix.m[0 * 4 + 3];
        yy = x * matrix.m[1 * 4 + 0] + y * matrix.m[1 * 4 + 1] + z
            * matrix.m[1 * 4 + 2] + matrix.m[1 * 4 + 3];
        zz = x * matrix.m[2 * 4 + 0] + y * matrix.m[2 * 4 + 1] + z
            * matrix.m[2 * 4 + 2] + matrix.m[2 * 4 + 3];
        ww = x * matrix.m[3 * 4 + 0] + y * matrix.m[3 * 4 + 1] + z
            * matrix.m[3 * 4 + 2] + matrix.m[3 * 4 + 3];
        if (ww == 1.0f)
...
struct vec4
{
    ...
    vec4 opBinary(string op : "*")(const ref mat4 matrix) const
    {
        float xx, yy, zz, ww;
        xx = x * matrix.m[0 * 4 + 0] + y * matrix.m[0 * 4 + 1] + z
            * matrix.m[0 * 4 + 2] + w * matrix.m[0 * 4 + 3];
        yy = x * matrix.m[1 * 4 + 0] + y * matrix.m[1 * 4 + 1] + z
            * matrix.m[1 * 4 + 2] + w * matrix.m[1 * 4 + 3];
        zz = x * matrix.m[2 * 4 + 0] + y * matrix.m[2 * 4 + 1] + z
            * matrix.m[2 * 4 + 2] + w * matrix.m[2 * 4 + 3];
        ww = x * matrix.m[3 * 4 + 0] + y * matrix.m[3 * 4 + 1] + z
            * matrix.m[3 * 4 + 2] + w * matrix.m[3 * 4 + 3];
...
struct mat4
{
    ...
    @property string dump() const
    {
        ...
        return to!string(m[0 .. 4]) ~ to!string(m[4 .. 8]) ~ to!string(
                m[8 .. 12]) ~ to!string(m[12 .. 16]);
    }
    ...
    {
        mat4 m;
        m.m[0 * 4 + 0] = m1.m[0 * 4 + 0] * m2.m[0 * 4 + 0] + m1.m[1 * 4 + 0]
            * m2.m[0 * 4 + 1] + m1.m[2 * 4 + 0] * m2.m[0 * 4 + 2] + m1.m[3 * 4 + 0] * m2.m[0 * 4 + 3];
        m.m[0 * 4 + 1] = m1.m[0 * 4 + 1] * m2.m[0 * 4 + 0] + m1.m[1 * 4 + 1]
            * m2.m[0 * 4 + 1] + m1.m[2 * 4 + 1] * m2.m[0 * 4 + 2] + m1.m[3 * 4 + 1] * m2.m[0 * 4 + 3];
        m.m[0 * 4 + 2] = m1.m[0 * 4 + 2] * m2.m[0 * 4 + 0] + m1.m[1 * 4 + 2]
            * m2.m[0 * 4 + 1] + m1.m[2 * 4 + 2] * m2.m[0 * 4 + 2] + m1.m[3 * 4 + 2] * m2.m[0 * 4 + 3];
        m.m[0 * 4 + 3] = m1.m[0 * 4 + 3] * m2.m[0 * 4 + 0] + m1.m[1 * 4 + 3]
            * m2.m[0 * 4 + 1] + m1.m[2 * 4 + 3] * m2.m[0 * 4 + 2] + m1.m[3 * 4 + 3] * m2.m[0 * 4 + 3];
        m.m[1 * 4 + 0] = m1.m[0 * 4 + 0] * m2.m[1 * 4 + 0] + m1.m[1 * 4 + 0]
            * m2.m[1 * 4 + 1] + m1.m[2 * 4 + 0] * m2.m[1 * 4 + 2] + m1.m[3 * 4 + 0] * m2.m[1 * 4 + 3];
        m.m[1 * 4 + 1] = m1.m[0 * 4 + 1] * m2.m[1 * 4 + 0] + m1.m[1 * 4 + 1]
            * m2.m[1 * 4 + 1] + m1.m[2 * 4 + 1] * m2.m[1 * 4 + 2] + m1.m[3 * 4 + 1] * m2.m[1 * 4 + 3];
        m.m[1 * 4 + 2] = m1.m[0 * 4 + 2] * m2.m[1 * 4 + 0] + m1.m[1 * 4 + 2]
            * m2.m[1 * 4 + 1] + m1.m[2 * 4 + 2] * m2.m[1 * 4 + 2] + m1.m[3 * 4 + 2] * m2.m[1 * 4 + 3];
        m.m[1 * 4 + 3] = m1.m[0 * 4 + 3] * m2.m[1 * 4 + 0] + m1.m[1 * 4 + 3]
            * m2.m[1 * 4 + 1] + m1.m[2 * 4 + 3] * m2.m[1 * 4 + 2] + m1.m[3 * 4 + 3] * m2.m[1 * 4 + 3];
        m.m[2 * 4 + 0] = m1.m[0 * 4 + 0] * m2.m[2 * 4 + 0] + m1.m[1 * 4 + 0]
            * m2.m[2 * 4 + 1] + m1.m[2 * 4 + 0] * m2.m[2 * 4 + 2] + m1.m[3 * 4 + 0] * m2.m[2 * 4 + 3];
        m.m[2 * 4 + 1] = m1.m[0 * 4 + 1] * m2.m[2 * 4 + 0] + m1.m[1 * 4 + 1]
            * m2.m[2 * 4 + 1] + m1.m[2 * 4 + 1] * m2.m[2 * 4 + 2] + m1.m[3 * 4 + 1] * m2.m[2 * 4 + 3];
        m.m[2 * 4 + 2] = m1.m[0 * 4 + 2] * m2.m[2 * 4 + 0] + m1.m[1 * 4 + 2]
            * m2.m[2 * 4 + 1] + m1.m[2 * 4 + 2] * m2.m[2 * 4 + 2] + m1.m[3 * 4 + 2] * m2.m[2 * 4 + 3];
        m.m[2 * 4 + 3] = m1.m[0 * 4 + 3] * m2.m[2 * 4 + 0] + m1.m[1 * 4 + 3]
            * m2.m[2 * 4 + 1] + m1.m[2 * 4 + 3] * m2.m[2 * 4 + 2] + m1.m[3 * 4 + 3] * m2.m[2 * 4 + 3];
        m.m[3 * 4 + 0] = m1.m[0 * 4 + 0] * m2.m[3 * 4 + 0] + m1.m[1 * 4 + 0]
            * m2.m[3 * 4 + 1] + m1.m[2 * 4 + 0] * m2.m[3 * 4 + 2] + m1.m[3 * 4 + 0] * m2.m[3 * 4 + 3];
        m.m[3 * 4 + 1] = m1.m[0 * 4 + 1] * m2.m[3 * 4 + 0] + m1.m[1 * 4 + 1]
            * m2.m[3 * 4 + 1] + m1.m[2 * 4 + 1] * m2.m[3 * 4 + 2] + m1.m[3 * 4 + 1] * m2.m[3 * 4 + 3];
        m.m[3 * 4 + 2] = m1.m[0 * 4 + 2] * m2.m[3 * 4 + 0] + m1.m[1 * 4 + 2]
            * m2.m[3 * 4 + 1] + m1.m[2 * 4 + 2] * m2.m[3 * 4 + 2] + m1.m[3 * 4 + 2] * m2.m[3 * 4 + 3];
        m.m[3 * 4 + 3] = m1.m[0 * 4 + 3] * m2.m[3 * 4 + 0] + m1.m[1 * 4 + 3]
            * m2.m[3 * 4 + 1] + m1.m[2 * 4 + 3] * m2.m[3 * 4 + 2] + m1.m[3 * 4 + 3] * m2.m[3 * 4 + 3];
        return m;
    }
    ...
    {
        float x, y, z, w;
        x = vector.x * m[0 * 4 + 0] + vector.y * m[1 * 4 + 0] + vector.z * m[2 * 4 + 0] + m[3 * 4
            + 0];
        y = vector.x * m[0 * 4 + 1] + vector.y * m[1 * 4 + 1] + vector.z * m[2 * 4 + 1] + m[3 * 4
            + 1];
        z = vector.x * m[0 * 4 + 2] + vector.y * m[1 * 4 + 2] + vector.z * m[2 * 4 + 2] + m[3 * 4
            + 2];
        w = vector.x * m[0 * 4 + 3] + vector.y * m[1 * 4 + 3] + vector.z * m[2 * 4 + 3] + m[3 * 4
            + 3];
        if (w == 1.0f)
            return vec3(x, y, z);
        else
    ...
    {
        float x, y, z, w;
        x = vector.x * m[0 * 4 + 0] + vector.y * m[1 * 4 + 0] + vector.z
            * m[2 * 4 + 0] + vector.w * m[3 * 4 + 0];
        y = vector.x * m[0 * 4 + 1] + vector.y * m[1 * 4 + 1] + vector.z
            * m[2 * 4 + 1] + vector.w * m[3 * 4 + 1];
        z = vector.x * m[0 * 4 + 2] + vector.y * m[1 * 4 + 2] + vector.z
            * m[2 * 4 + 2] + vector.w * m[3 * 4 + 2];
        w = vector.x * m[0 * 4 + 3] + vector.y * m[1 * 4 + 3] + vector.z
            * m[2 * 4 + 3] + vector.w * m[3 * 4 + 3];
        return vec4(x, y, z, w);
    }
...
void flattenBezier(alias BezierFunc)(const PointF[] cp,
        int segmentCountInclusive, PointF[] outSegments)
        if (is(typeof(BezierFunc) == function))
{
    if (segmentCountInclusive < 2)
        return;
